...
<head>
	...
	<script>var __loaderConfig={appBase:"s/j/app/",libBase:"{libbase}",server:"{server}"};</script>
	<script src="http://{server}/{env}{libbase}neuron-active.js"></script>
	<script>DP.__loader.init();</script>
	<script src="/tools/qunit/qunit.js"></script>
	<link rel="stylesheet" href="/tools/qunit/qunit.css" />
	{css}
</head>
<body>
	{html}
